...
echo_and_run cd "/home/amadeus/forTurtle/src/dynamixel_motor_for_noetic/dynamixel_controllers"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/amadeus/forTurtle/src/dynamixel_motor_for_noetic/dynamixel_controllers/setup.py" \
     \
    build --build-base "/home/amadeus/forTurtle/build/dynamixel_motor_for_noetic/dynamixel_controllers" \
    install \
    --root="${DESTDIR-/}" \
