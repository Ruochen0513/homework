...
echo_and_run cd "/home/amadeus/forTurtle/src/kobuki_desktop/kobuki_dashboard"
...
echo_and_run /usr/bin/env \
    ...
    "/home/amadeus/forTurtle/src/kobuki_desktop/kobuki_dashboard/setup.py" \
     \
    build --build-base "/home/amadeus/forTurtle/build/kobuki_desktop/kobuki_dashboard" \
    install \
    --root="${DESTDIR-/}" \
